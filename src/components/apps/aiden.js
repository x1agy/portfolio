  ...
  renderNavLinks = () => {
    return (
      <>
        ...
        >
          <img className=" w-3 md:w-4" alt="aiden vivek" src="./themes/Yaru/status/about.svg" />
    ...
    <>
      ...
      <div className=" mt-2 text-lg md:text-2xl text-center px-1">
        ...
        <div className="font-normal ml-1">
          I'm a{' '}
          <span className="text-pink-600 font-bold">Full Stack and Blockchain Developer!</span>
        </div>
      </div>
      ...
      <ul className=" my-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc my-2 md:text-base">
          ...
          <span className="font-bold">Web2</span> and <span className="font-bold">Web3</span>{' '}
          industries.
        </li>
        <li className=" list-pc my-2 md:text-base">
          Experience in <span className="font-bold">Leading a Team</span> of front end, back end and
          smart contract developers at <span className="font-bold">KURONURI</span> project.
        </li>
        <li className=" list-pc my-2 md:text-base">
          Developed <span className="font-bold">a comprehensive DeFi</span>,{' '}
          <span className="font-bold">NFT marketplaces</span>,{' '}
          <span className="font-bold">Tokens</span> and 20+ <span className="font-bold">Web3</span>{' '}
          projects including <span className="font-bold">P2E games</span> on Ethereum, Polygon,
          Binance Smart Chain and so on.
        </li>
        <li className=" list-pc my-2 md:text-base">
          Advanced knowledge of multiple programming languages, frameworks and several database
          structures.
        </li>
        <li className=" list-pc my-2 md:text-base">
          Reliable team player offering exceptional analytical and time management skills and the
          important ability to think critically and solve complex problems.
        </li>
      </ul>
    </>
  );
  ...
  const project_list = [
    {
      ...
      description: [
        <p>
          Engineered the backend using Node.js, TypeScript, Express.js, and MongoDB, establishing a
          scalable and efficient infrastructure capable of handling millions of transactions per
          day, and implemented real-time chat and game functionalities using the Socket.io module.
        </p>,
        <p>
          Integrated third-party payment APIs to ensure secure token deposits and withdrawals, while
          also utilizing AI services to enhance security and user experience by filtering user
          images.
        </p>,
        <p>
          Designed and implemented robust user authentication mechanisms, including CAPTCHA, JWT
          tokens, and session management, while synchronizing sessions with Socket.io to maintain
          consistent and accurate user information across both the game and website platforms.
        </p>,
        <p>
          Developed comprehensive affiliate page functionalities and an efficient ticketing system
          for user support, alongside creating advanced admin features and analytics tools to
          facilitate data-driven decision-making and operational efficiency.
        </p>,
        <p>
          Employed Docker for containerization and Git for version control, collaborating
          effectively with frontend developers and game developers to ensure cohesive, timely
          project delivery, while optimizing database queries and improving system performance,
    ...
    },
    {
      ...
      description: [
        <p>
          Worked as a back-end and smart contract developer in an agile team communicating directly
          with the CTO.
        </p>,
        <p>
          Created the user review API, automatic review aggregation engine and embeddable badge
          generation engine using node.js/typescript and express.js.
        </p>,
        <p>
          Used mongoDB aggregation pipeline for review aggregation engine, and integrated with smart
          contract using web3.js to store the aggregation results.
        </p>,
        <p>
          Implemented CI/CD pipeline to automate comprehensive project testing and efficient
          deployment processes using github workflow actions.
        </p>,
        <p>
          Successfully conducted thorough API testing leveraging the Cypress and Jest testing
          libraries, while simultaneously generating API document via the Swagger API framework.
        </p>,
        <p>
          Effectively leveraged Docker to efficiently package, deploy, and manage applications
          across diverse environments, guaranteeing consistency and portability.
        </p>,
      ],
    },
    {
      ...
      description: [
        <p>
          Accomplished in building a comprehensive DeFi ecosystem, Token Generation and ICO
          platforms, 5 play-to-earn games, 2 NFT marketplaces including over 20 Web3 projects and
          tools.
        </p>,
        <p>
          Developed an automated DEX bot for Burn&Drop and a CEX bot for trading integrated with the
          Bitcastle CEX platform.
        </p>,
        <p>
          Designed and developed robust token Bridges for frictionless asset transfers between
          blockchain networks and implemented Cross-Chain solutions.
        </p>,
        <p>
          Leveraged Web3.js and Ethers.js to establish seamless interaction between the React.js,
          Vue.js front-end and smart contract.
        </p>,
        <p>
          Managed the CI / CD solution for a development team using the CircleCI tool, Bitbucket,
          Github and AWS Lambda functions.
        </p>,
        <p>
          Utilized GraphQL API to enhance communication performance between the front-end and
          back-end.
        </p>,
        <p>
          Constructed and integrated an internal back-end synchronized with the blockchain database,
          utilizing Node.js and Express.js.
        </p>,
      ],
    },
    {
      ...
      description: [
        ...
        <p>
          Developed the smart contracts to interact with Value DeFi protocol including liquidity
          pools, yield farming strategies and governance mechanisms.
        </p>,
        <p>
          Tested the smart contracts using Truffle and Hardhat framework and deployed successfully
          on Binance Smart Chain.
        </p>,
        <p>
          Integrated the smart contracts with front-end using Ethers.js and Web3.js to enable users
          interact with liquidity pools, stake assets and participate in yield farming
          opportunities.
        </p>,
      ],
    },
    {
      name: (
        <p>
          ...
          <a className="border-b-2" href="https://incarta.com.au/" target="_blank" rel="noreferrer">
            INCARTA
          </a>
        </p>
      ),
      ...
      description: [
        <p>
          Improved patient treatment rates by 20% through the developing and implementing of machine
          learning algorithms.
        </p>,
        <p>
          Instrumental in designing and developing clinical charts using React.js and D3.js,
          contributed to patient care during the COVID-19 pandemic.
        </p>,
        <p>
          Developed and delivered multiple healthcare platforms using React.js, Angular, Vue.js,
          with Laravel, PHP framework and Node.js focusing on clear client communication.
        </p>,
        <p>
          By using react.js, next.js and node.js, created reusable components and made functions
          modular to connect with the backend, which has led to a 15% improvement in site speed and
          performance.
        </p>,
      ],
    },
    {
      ...
      description: [
        <p>
          In an Agile, collaborative environment, effectively gathered design requirements, and
          conducted thorough application testing, resulting in a notable 25% increase in working
          speed. • Leading troubleshooting efforts, fixed more than 300+ bugs and other issues, and
          updated sites throughout the production lifecycle.
        </p>,
        <p>
          Improved the website's user interface and optimized its speed, resulting in a 35% speed
          improvement and a 20% increase in user engagement.
        </p>,
        <p>
          Collaborated with the data science team to develop algorithms that matched over 80% of our
          platform's users with top-performing agents, as a result, 25% increase in customer
          satisfaction.
        </p>,
        <p>
          Be proud of contributing to this project and look forward to applying my knowledge and
          experience in my future career endeavors.
        </p>,
      ],
    },
    {
      name: (
        <p>
          ...
          <a className="border-b-2" href="https://legrand.jp/" target="_blank" rel="noreferrer">
            Le Grand Co, Ltd.
          </a>
        </p>
      ),
      ...
      description: [
        <p>
          Worked in an Agile, collaborative environment to receive design requirements, peer
          program, and test applications
        </p>,
        <p>
          Maintained and updated 20+ web pages, graphics, and online marketing materials in
          collaboration with the UX manager and development team.
        </p>,
        <p>
          Leading troubleshooting efforts, fixing more than 1,000 bugs and other issues, and updated
          sites throughout the production lifecycle.
        </p>,
        <p>Created the complex UI components using react/typescript and scss.</p>,
        <p>
          Improved the process of storing app state info by implementing the Redux store, and
          successfully integrated the front-end with Rest APIs.
        </p>,
      ],
    },
  ];
          ...
          <div className="w-full py-4 px-4 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5">
            <div className="flex flex-wrap justify-between items-center">
              <div className="flex justify-center items-center">
                <div className=" text-base font-semibold md:text-lg mr-2">{project.name}</div>
              </div>
              <div className="text-gray-300 font-light text-sm">{project.date}</div>
            </div>
            <ul className=" tracking-normal leading-tight text-sm font-light ml-6 mt-2">
              {project.description.map((desc, index) => (
                <li key={index} className="list-disc mt-1 text-gray-100 md:text-base">
                  {desc}
                </li>
              ))}
            </ul>
  ...
  const project_list = [
    {
      ...
      domains: ['Web3.js', 'Wallet', 'React.js', 'TailwindCSS', 'Typescript', 'Crypto'],
    },
    {
      name: 'Roppongi Ai',
      ...
      description: [<p>AI website development</p>, <p>Wordpress theme</p>, <p>Elementor Pro</p>],
    ...
    },
    {
      ...
      domains: ['Dapp', 'Lotto', 'Blockchain', 'Solidity', 'React.js', 'Web3.js'],
    },
    {
    ...
    },
    {
      ...
      description: [
        ...
        <p>
          Created the user review API, automatic review aggregation engine, automatic review logo
          generation engine
        </p>,
        <p>Integrated with smart contract using web3.js and synced with backend</p>,
        <p>
          Implemented the backend including database using cypress and jext testing library and
          finalize the API document using swagger API framework
        </p>,
      ],
      domains: [
        'Node.js',
    ...
    },
    {
      ...
      domains: ['react.js', 'css', 'AI', 'D-ID', 'API integration', 'animation', 'video'],
    },
    {
      ...
      description: [<p>Use chatGPT</p>, <p>Use Microsoft Azure for TTS function</p>],
      domains: ['react.js', 'typescript', 'scss', 'AI', 'chatGPT', 'microsoft', 'tts'],
    },
    {
      ...
      description: [
        <p>
          ...
          <span className="font-medium">Golden Tree</span> that can make the token price{' '}
          <span className="font-medium">never go down</span>, and{' '}
          <span className="font-medium">rise day by day</span>
        </p>,
        <p>
          Designed that <span className="font-medium">SMTC token</span> that is the main token of
          Golden Tree that has the special mechanism will be{' '}
    ...
    },
    {
      ...
      description: [
        ...
        <p>Created the bridge backend and bridge smart contract on ethereum and binance</p>,
    ...
    },
    {
      ...
      description: [
        <p>
          Users can swap the crypto to real cash using this platform. We made the secure pool that
          user can deposit token to make a contract.
        </p>,
      ],
      domains: [
        'react.js',
    ...
    },
    {
      ...
      description: [
        <p>
          PEPE SUSHI is a member of the PEPE family. The PEPE family loved sushi and wanted to
          become a sushi chef, so they came to learn the technique Japan. It also offers a service
          called The Messages, which will be a platform where the messages you post will be
          permanently recorded on the blockchain. Every time a message is posted, PEPES is inspired
          by mysterious tokens that burn indefinitely!
        </p>,
      ],
      domains: [
        'react.js',
    ...
    },
    {
      ...
      description: [
        ...
        <p>Support PEPE Bep20, PEPE Sushi, PEPE MSG and more than 11 meme tokens</p>,
    ...
    },
    {
      ...
      description: [
        <p>
          Burn & Drop is the service that burns and airdrop each token to make a token price rising
          up.
        </p>,
        <p>Support PEPE Bep20, PEPE Sushi, PEPE MSG and more than 11 meme tokens</p>,
        <p>PEPE Syndicate</p>,
    ...
    },
    {
      ...
      description: [
        ...
        <p>
          Experience the Fusion of Meme Coin and Social Media: Power Up Your Blockahin Experience!
        </p>,
        <p>
          $TBNB, $ARMY, and $MSG. $MSG is on Binance Smart Chain, while the others are on the
          testnet.
        </p>,
      ],
      domains: [
    ...
    },
    {
      ...
      description: [
        ...
        <p>
          Planning to develop <span className="font-medium">combine place</span> where makes NFT
          more <span className="font-medium">stronger</span>
        </p>,
        <p>
          NFTs will be used as the <span className="font-medium">game assets</span>
        </p>,
      ],
      domains: [
        'react.js',
    ...
    },
    {
      ...
      description: [
        <p>
          The platform that brings fundraising to the global stage by combining traditional web2 and
          the emerging web3 industries.
        </p>,
        <p>Koi fishes will be growing day by day</p>,
        <p>Change water function</p>,
        <p>Fish swimming speed will be decreased based on the weight growing day by day</p>,
        <p>
          NFTs will be used as the <span className="font-medium">game assets</span>
        </p>,
      ],
    ...
    },
    {
      ...
      description: [
        ...
        <p>
          Create token easily within <span className="font-medium">10 seconds by one click</span>
        </p>,
        <p>
          Plan to add <span className="font-medium">more evm chains</span> such like polygon, avax
          and etc.
        </p>,
      ],
      domains: [
    ...
    },
    {
      ...
      description: [
        ...
        <p>
          Create NFT easily within <span className="font-medium">10 seconds by one click</span>
        </p>,
        <p>
          Plan to add <span className="font-medium">more evm chains</span> such like polygon, avax
          and etc.
    ...
    },
    {
      ...
      description: [
        <p>
          Create the gold, silver and bronze types of congratulation messages to the blockchain
        </p>,
        <p>Use the WBC token</p>,
        <p>Share more SNS information by choosing the gold message</p>,
        <p>Plan to add more feature</p>,
      ],
      domains: ['react.js', 'typescript', 'web3.js', 'solidity', 'binance smart chain'],
    },
    {
    ...
    },
    {
      ...
      domains: ['vue.js', 'web3.js', 'play to earn', 'solidity', 'binance smart chain'],
    },
    {
      name: 'Partner',
      date: 'Mar 2023',
    ...
    },
    {
      ...
      description: [
        <p>
          With over 25 years experience in the Health and Life Sciences sector, Incarta has a
          demonstrated history of innovation in hardware and software development. Our leading
          clinical records platform “Alarta” is amongst the most advanced cloud based critical care
          medical record systems available anywhere. It is also one of the most cost effective.
          Alarta can be deployed within a few hours auto-configuring itself via HL7.
        </p>,
      ],
      domains: ['chatGPT', 'react.js', 'node.js', 'express.js'],
    },
    ...
    },
    {
      ...
      domains: ['ionic', 'angular', 'node.js', 'express.js', 'postgreSql', 'scss'],
    },
    {
      name: 'Kingdom Battle',
      date: 'July 2022',
      ...
      description: [
        <p>
          <span className="font-medium">Play to Earn</span> web3 battle type of game
        </p>,
        <p>
          Support <span className="font-medium">multiplayer</span> mode in which up to{' '}
          <span className="font-medium">8 players</span> playing together
        </p>,
        <p>Defeat goblins and enemy boss to get the more token</p>,
      ],
      domains: ['unity3D', 'solidity', 'web3.js', 'webgl', 'play to earn', 'binance smart chain'],
    },
    {
      name: 'World Speed',
      date: 'Sep 2022',
    ...
    },
    {
      ...
      description: [
        ...
        <p>
          Survive <span className="font-medium">as long as possible</span> to get the more token
        </p>,
        <p>
          Plan to add <span className="font-medium">multiplayer</span> mode
        </p>,
    ...
    },
    {
      ...
      description: [
        <p>
          <span className="font-medium">Play to Earn</span> web3 puzzle game (2048)
        </p>,
        <p>
          Play on the <span className="font-medium">easy, middle and hard</span> mode with the
          limited time
        </p>,
        <p>
          Solve the puzzle <span className="font-medium">as soon as possible</span> before time is
          up to get the more token
        </p>,
      ],
      domains: ['unity3D', 'solidity', 'web3.js', 'webgl', 'play to earn', 'binance smart chain'],
    },
    {
      ...
      description: [
        <p>
          <span className="font-medium">Play to Earn</span> web3 block down game (tetris)
        </p>,
        <p>
          Play on the <span className="font-medium">easy, middle and hard</span> mode
        </p>,
        <p>
          Match the block to the <span className="font-medium">right place</span> and break{' '}
          <span className="font-medium">as much as possible</span> get the more token
        </p>,
      ],
      domains: ['unity3D', 'solidity', 'web3.js', 'webgl', 'play to earn', 'binance smart chain'],
    },
        ...
        <div className="flex w-full flex-col px-4" key={index}>
          <div className="w-full flex flex-col lg:flex-row gap-2 py-3 px-3 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 ">
            ...
            <div className="w-full">
              ...
              <ul className=" tracking-normal leading-tight text-sm font-light ml-6 mt-2">
                {project.description.map((desc, index) => (
                  <li key={index} className="list-disc mt-2 text-gray-100 md:text-base">
                    {desc}
                  </li>
                ))}
              </ul>
